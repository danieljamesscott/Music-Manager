 ...
 */
class MusicModelArtists extends JModel
{
	var $_data = null;
	var $_total = null;
	...
	/**
	 * Method to get artist item data
	 *
	 * @access public
	 * @return array
	 */
	...
	/**
	 * Method to get the total number of artist items
	 *
	 * @access public
	 * @return integer
	 */
	...
	/**
	 * Method to get a pagination object for the artist
	 *
	 * @access public
	 * @return integer
	 */
	...
	function _buildQuery()
	{
		...
		$query = ' SELECT a.*, a.name AS artist, u.name AS editor '
			. ' FROM #__artists AS a '
